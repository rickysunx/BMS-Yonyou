 ...
 */
import java.util.*;
public class NCSubjRef extends nc.ui.pub.beans.UIDialog implements nc.ui.bank_cvp.compile.formulaedit.IReference {
...
class IvjEventHandler implements java.awt.event.ActionListener {
		public void actionPerformed(java.awt.event.ActionEvent e) {
			if (e.getSource() == NCSubjRef.this.getBnOK()) 
				connEtoC1();
			if (e.getSource() == NCSubjRef.this.getUIButton2()) 
				connEtoC2();
		};
	};
 ...
 */
public NCSubjRef(java.awt.Container parent) {
	super(parent);
	initialize();
}
/**
 ...
 */
public NCSubjRef(java.awt.Container parent, String title) {
	super(parent, title);
}
/**
 * NCSubjRef 构造子注解。
 ...
 */
public NCSubjRef(java.awt.Frame owner) {
	super(owner);
}
/**
 * NCSubjRef 构造子注解。
 ...
 * @param title java.lang.String
 */
public NCSubjRef(java.awt.Frame owner, String title) {
	super(owner, title);
}
/**
...
private void initialize() {
	...
	try
	{
		getCmbAttr().addItem("余额");
		getCmbAttr().addItem("发生额");
		getCmbAttr().addItem("本年累计");
		//biz
		...
		getRefncsubj().setRefModel(new RefKmModel());
	}
	catch(Exception e)
	{
		handleException(e);
...
public static void main(java.lang.String[] args) {
	try {
		NCSubjRef aNCSubjRef;
		aNCSubjRef = new NCSubjRef();
